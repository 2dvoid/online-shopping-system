...
-- Creates a custom function: getcat(x) which searcher for the x category.
DELIMITER $$
--
-- Procedures
--
...
(1, 4, 6, 'Thinkplus TWS Earbuds', 3000, 'True Wireless Earbuds', 'gadgets1.jpg', 'TWS Earbuds Earphone'),
(2, 4, 6, 'JBL Wireless Headphone', 8000, 'JBL Wireless Headphone', 'gadgets2.jpg', 'Headphone JBL'),
(3, 4, 6, 'Fast Charging USB Cables', 990, '240 watt fast charging cables', 'gadgets3.jpg', 'usb cable'),
(4, 4, 6, 'iPhone 16 Pro Max', 110000, 'Apple iphone 15 Pro Max', 'gadgets4.jpg', 'Phone iphone'),
(5, 4, 6, 'Macbook M3 Pro', 140000, 'Macbook M3 Pro', 'gadgets5.jpg', 'Macbook laptop'),
(6, 5, 6, 'RGB LED', 300, 'RGB LED', 'home1.jpg', 'led rgb'),
(7, 5, 6, 'Moon Lamp', 1500, 'Moon Lamp Home Decor', 'home2.jpg', 'lamp moon home decor'),
(8, 2, 6, 'Blue Color Three Piece', 3000, 'Blue Color Three Piece', 'ladies1.jpg', 'three piece girls'),
(9, 2, 6, 'Dress Set', 5500, 'Dress Set', 'ladies2.jpg', 'Dress set'),
